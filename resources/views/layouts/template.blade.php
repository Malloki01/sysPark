                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                        ...
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                <h6>@guest Rodrigo @else {{ Auth::user()->name }} @endguest</h6>
                            </div>
                        </div>
                        ...
                        <a href="{{url('tipos')}}">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <path d="M10.29 3.86l-7.19 12.42A2 2 0 0 0 5 19h14a2 2 0 0 0 1.71-2.72l-7.19-12.42a2 2 0 0 0-3.42 0z"></path>
